...
$(".slider").slick({infinite:!0,dots:!1,responsive:[{breakpoint:769,settings:{arrows:!1}}]}),$(".header__link a").click(function(e){e.preventDefault();e=$(this).data("slide");$(".slider").slick("slickGoTo",e)}),$(".slider-for").slick({slidesToShow:1,slidesToScroll:1,arrows:!1,swipe:!1,fade:!0,adaptiveHeight:!0,asNavFor:".slider-nav"}),$(".slider-nav").slick({slidesToShow:3,slidesToScroll:1,asNavFor:".slider-for",dots:!0,arrows:!0,centerMode:!0,focusOnSelect:!0,autoplaySpeed:2e3,swipe:!1,responsive:[{breakpoint:769,settings:{slidesToShow:2}},{breakpoint:500,settings:{slidesToShow:1,dots:!1}}]}),$(".mobile__menu").click(function(){$(".header__wrap__mobile").slideToggle(500)}),$(document).ready(function(){$(".slider-for div img").click(function(){var e=$(this).attr("src");$("#fullScreenImage").attr("src",e),$("#overlay").fadeIn("fast"),$("#overlay").css("display","flex")}),$("#overlay").click(function(){$(this).fadeOut("fast")})});